...
import type { GrantFund, GrantFundInterface } from '../GrantFund';
...
export class GrantFund__factory {
  static readonly abi = _abi;
  static createInterface(): GrantFundInterface {
    return new utils.Interface(_abi) as GrantFundInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): GrantFund {
    return new Contract(address, _abi, signerOrProvider) as GrantFund;
  }
}
