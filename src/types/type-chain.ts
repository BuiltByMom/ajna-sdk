...
export type POOL_CONTRACT = TOKEN_POOL | PoolInfoUtils;
export type TOKEN_POOL_FACTORY = ERC20PoolFactory | ERC721PoolFactory;
export type TOKEN_POOL_CONTRACTS = TOKEN_CONTRACT | TOKEN_POOL | TOKEN_POOL_FACTORY;
