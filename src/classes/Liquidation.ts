...
import { POOLS_CONTRACTS, Address, CallData, PoolInfoUtils, SignerOrProvider } from '../types';
...
export class Liquidation {
   ...
   */
  constructor(provider: SignerOrProvider, pool: POOLS_CONTRACTS, borrowerAddress: Address) {
